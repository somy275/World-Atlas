        ...
        <>
            ...
            <div className="relative h-screen w-screen  flex items-center justify-center text-white ">
                <form ref={form} onSubmit={handleSubmit(onSubmit)} className="bg-[#003f5cc7] mt-[3.5rem] h-[50%] w-[80%] min-h-[350px] max-h-[400px] min-[450px]:max-h-[500px] min-[450px]:max-w-[430px] min-[450px]:min-h-[400px] lg:h-[67%] lg:w-[max(28%,50vh)] lg:min-h-[380px] lg:max-h-[700px] lg:max-w-[600px] rounded-md flex flex-col justify-between py-[3rem]  items-center ">
                    ...
                    <InputOtp value={value} name="otp" classNames={{ segmentWrapper: "flex items-center justify-around gap-2", segment: "bg-[white] text-black  data-[active=true]:bg-[#c8d0dc] items-center h-[max(2.5rem,4.5vh)] w-[max(2.5rem,4.5vh)] lg:h-[max(3.2vw,5.8vh)] lg:w-[max(3.2vw,5.8vh)] lg:max-h-[60px] lg:max-w-[60px] flex flex-row justify-center" }} className="items-center flex-row" color="primary" length={4} onValueChange={setvalue} {...register("otp", { required: true })} />
                    {
